...
The simulation verifies the following functionalities of the Shift Register:

- Correct parallel-to-serial conversion during transmission.
- Correct serial-to-parallel conversion during reception.
- Proper MOSI data shifting.
- Correct MISO data sampling.
- Support for both MSB-first and LSB-first transmission.
- Correct operation under all SPI modes using CPOL and CPHA timing signals.
- Proper synchronization with timing pulses generated by the Baud Generator.
